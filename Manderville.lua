...
description: e
  ...
  Shoutout baanderson40 for the base script from his current relic script
plugin_dependencies:
- AutoDuty
- Lifestream
- vnavmesh
...
local PHANTOM_VILLAGE_ID   = 963
local MATHEMATICS_ITEM_ID  = 28

-- Tome Exchange NPC (localized name from ENpcResident)
local TOME_EXCHANGE_NPC_ID = 1043892
local TomeExchange = {
    id       = TOME_EXCHANGE_NPC_ID,
    name     = nil,
    position = Vector3(48.325, 0.000, -12.802),
}
